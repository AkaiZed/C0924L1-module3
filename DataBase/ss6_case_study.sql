...
(5, 'Nguyễn Bình Phát', '1999-12-29', '454363232', 6000000, '0920341231', 'phatphat@gmail.com', '43 Yên Bái, Đà Nẵng', 2, 3, 1),
(6, 'Khúc Nguyễn An Nghi', '2000-11-08', '964542311', 7000000, '0978652313', 'annghi20@gmail.com', '294 Nguyễn Tất Thành, Đà Nẵng', 2, 3, 2),
(7, 'Nguyễn Hữu Hà', '1993-01-01', '534323231', 8000000, '0941234553', 'nhh0101@gmail.com', '4 Nguyễn Chí Thanh, Huế', 2, 4, 3),
(8, 'Nguyễn Hà Đông', '1989-09-03', '234414123', 9000000, '0642123111', 'donghanguyen@gmail.com', '111 Hùng Vương, Hà Nội', 2, 4, 4),
(9, 'Tống Hoàng', '1982-09-03', '256781231', 6000000, '0245144444', 'hoangtong@gmail.com', '213 Hàm Nghi, Đà Nẵng', 2, 3, 4),
...
(1, 'Nguyễn Thị Hảo', '1970-11-07', 0, '643431213', '0945423362', 'thhao07@gmail.com', '23 Nguyễn Hoàng, Đà Nẵng', 5),
(2, 'Phạm Xuân Diệu', '1992-08-08', 1, '865432123', '0954333333', 'xuandieu92@gmail.com', 'K77/22 Thái Phiên, Quảng Trị', 3),
(3, 'Trương Đình Nghệ', '1990-02-27', 1, '438645199', '0372313122', 'nghenhan2702@gmail.com', 'K323/12 Ông Ích Khiêm, Vinh', 2),
(4, 'Dương Văn Quân', '1981-07-08', 1, '543432111', '0490039241', 'duongquan@gmail.com', 'K453/12 Lê Lợi, Đà Nẵng', 1),
(5, 'Hoàng Trần Nhi Nhi', '1995-12-09', 0, '795453345', '0312454678', 'nhinhi123@gmail.com', '224 Lý Thái Tổ, Gia Lai', 4),
(6, 'Tôn Nữ Mộc Châu', '2005-12-06', 0, '732434215', '0988888844', 'tonnuchau@gmail.com', '37 Yên Thế, Đà Nẵng', 4),
(7, 'Nguyễn Mỹ Kim', '1984-04-08', 0, '965465433', '0912345698', 'kimcuong84@gmail.com', 'K123/45 Lê Lợi, Hồ Chí Minh', 3),
(8, 'Nguyễn Thị Hảo', '1999-04-08', 0, '965654633', '0935456789', 'haohxa99@gmail.com', '55 Nguyễn Văn Linh, Kon Tum', 1),
(9, 'Trần Đại Danh', '1994-07-01', 1, '432341235', '0643343433', 'danhhai99@gmail.com', '24 Lý Thường Kiệt, Quảng Ngãi', 5),
(10, 'Nguyễn Tâm Đắc', '1989-07-01', 1, '344343432', '0987654231', 'dactam@gmail.com', '22 Ngô Quyền, Đà Nẵng', 2);
...
(3, 'Room Twin 01', 5000, 1000000, 2, 'normal', 'Có thể', NULL, NULL, 4, 3),
(4, 'Villa No Beach Front', 22000, 9000000, 8, 'normal', 'Có hồ bơi', 300, 3, 3, 1),
(5, 'House Princess 02', 10000, 4000000, 5, 'normal', 'Có thêm bếp nướng', NULL, 2, 3, 2),
(6, 'Room Twin 02', 3000, 9000000, 2, 'normal', 'Có thể', NULL, NULL, 4, 3);
...
(7, 2, 1, 2),
(8, 2, 12, 2);
-- DROP DATABASE IF EXISTS casestudy_sql;
...
WHERE dv.ma_dich_vu IN (
    SELECT DISTINCT hd_2020.ma_dich_vu
    FROM hop_dong hd_2020
    WHERE YEAR(hd_2020.ngay_lam_hop_dong) = 2020
)
AND dv.ma_dich_vu NOT IN (
    SELECT DISTINCT hd_2021.ma_dich_vu
    FROM hop_dong hd_2021
    WHERE YEAR(hd_2021.ngay_lam_hop_dong) = 2021
);
...
-- Cách 3
SELECT ho_ten FROM (
    SELECT ho_ten, ROW_NUMBER() OVER (PARTITION BY ho_ten ORDER BY ma_khach_hang) AS row_num
    FROM khach_hang
) AS temp
WHERE row_num = 1;
